...
model = load_model('digits_4layer.h5')
...
class App(tk.Tk):
    def __init__(self):
        ...
        self.label = tk.Label(self, text="Write the digit", font=("Helvetica", 24))
        self.classify_btn = tk.Button(self, text = "Detect", command =self.classify_handwriting) 
        self.button_clear = tk.Button(self, text = "Reset", command = self.clear_all)
